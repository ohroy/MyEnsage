...
namespace wtf.Parts
{
    ...
    public class Menu
    {
        ...
        public MenuItem<bool> UltFirstEnabled;
        ...
        public void install()
        {
            ...
            var ksMenu= _factory.Menu("Auto Killsteal");

            IsAutoKillStealEnabled = ksMenu.Item("Auto Killsteal", true);
            UltFirstEnabled= ksMenu.Item("ult first", false);
